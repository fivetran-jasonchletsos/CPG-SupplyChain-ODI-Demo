...
//
// Ported from Clarity Health for Cardinal Provisions (CPG, downstream
// supply chain). Same SOURCES / DATA LAKEHOUSE / CONSUMERS layout, with
// CPG-specific footer copy:
//   - "Retailer POS streams via Kafka" (was Kinesis/HL7 in Clarity)
//   - "SOC 2 · GDPR · row-level access · column masking" (was HIPAA)
...
interface Props {
  ...
  engines: EngineNode[];
  roles?: ConsumerRole[];
  /** Brand accent. Default: Cardinal crimson. */
  accent?: string;
...
export function AliveMedallion({
  ...
  roles = [
    { label: 'Brand Mgrs',      sub: 'share & margin' },
    { label: 'Supply Planners', sub: 'forecast & OTIF' },
    { label: 'Sales Ops',       sub: 'account performance' },
    { label: 'Trade Marketing', sub: 'promo ROI' },
  ],
  accent = '#b1182b',
      ...
      <div className="am-grid">
        ...
        <section className="am-zone am-zone-sources">
          ...
          <footer className="am-zone-footer">
            ...
            <span>CDC + batch via Fivetran <span style={{ color: '#9ca3af' }}>·</span> Retailer POS streams via Kafka</span>
          </footer>
        </section>
        ...
        <section className="am-zone am-zone-consumers">
          ...
          <div className="am-hipaa-band">
            ...
            <span className="am-hipaa-detail">SOC 2 · GDPR · row-level access · column masking</span>
          </div>
    ...
    case 'hl7':
      return (
        <svg {...common}>
          ...
          <text x="12" y="16" textAnchor="middle" fontSize="9" fontWeight="900" fill="#ffffff" fontFamily="Helvetica, Arial, sans-serif">POS</text>
        </svg>
      );
    case 'cms':
      return (
        <svg {...common}>
          ...
          <text x="12" y="16" textAnchor="middle" fontSize="7" fontWeight="900" fill="#ffffff" fontFamily="Helvetica, Arial, sans-serif">NLSN</text>
        </svg>
      );
    case 'sec':
...
.am-medallion-gold   { border-top-color: #b1862b; }
