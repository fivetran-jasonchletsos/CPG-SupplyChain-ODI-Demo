...
// Mirrors wizardTypes.ts shape but for a Fivetran Activations sync run
...
export interface ActivationScenario {
  ...
  destination_system: string;  // e.g. "Uber Freight"
  destination_object: string;  // e.g. "Spot_Tender_Request"
